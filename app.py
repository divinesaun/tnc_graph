...
def action(state: AgentState):
    ...
    if is_url(question):
        if is_available:
            ...
            Always remind the user that your response is simply a breakdown and should not substitute legal advice in bold capital letters at the beginning.
            If there's something wrong with the webpage return 'There is something wrong with this webpage..🫤'"""
